        ...
        >
          <div className="relative w-72 h-72 md:w-96 md:h-96">
            ...
            <motion.div 
              ...
              className="absolute -top-4 -right-2 md:-right-4 glass px-3 py-2 md:px-4 md:py-2 rounded-xl flex items-center gap-2 z-20 shadow-lg scale-90 md:scale-100"
            >
            ...
            <motion.div 
              ...
              className="absolute bottom-10 -left-4 md:-left-8 glass px-3 py-2 md:px-4 md:py-2 rounded-xl flex items-center gap-2 z-20 shadow-lg scale-90 md:scale-100"
            >
            ...
            <motion.div 
              ...
              className="absolute bottom-2 md:-bottom-4 right-4 md:right-10 glass px-3 py-2 md:px-4 md:py-2 rounded-xl flex items-center gap-2 z-20 shadow-lg scale-90 md:scale-100"
            >
